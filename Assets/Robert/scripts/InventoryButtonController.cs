...
public class InventoryButtonController: MonoBehaviour
{
    ...
    [HideInInspector]public static bool OpenInventoryWindow = false;
    ...
    void Start()
    {
        ...
        //Inventory = GameObject.Find("InventoryItemBoxes")
    }
    ...
    void Update()
    {
       ...
       // if (InventoryInterface.activeSelf == true)
      //  {
            //animator.SetBool("selected", false);
       //     InventoryInterface.SetActive(false);
      //  }
      //  else if (InventoryInterface.activeSelf == false)
      //  {
    ...
    void OnMouseDown()
    {
        ...
        //if (OpenInventoryWindow == false)
       // {
           
            
       // }

      //  else if (OpenInventoryWindow== true)
      //  {
    ...
    {
        InventoryInterface.SetActive(true);
        Inventory.GetComponent<InventorySelectControl>().InstantiateAllBoxes();
    }
